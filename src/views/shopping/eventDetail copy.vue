    ...
    <div class="container">
      ...
      <div class="detail">
        <div class="detailLeft">
          ...
          <div class="participants">733 participants</div>
          <div class="time">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
            ...
            Jan 12,2025 18:00 - 20:00
          </div>
          <div class="price">
            <div class="priceText">$58</div>
            <div class="button" @click="Buy">Buy Ticket</div>
          </div>
        </div>
        <div class="detailRight">
          ...
          <div class="positioning">
            ...
            <div class="posiBottom">Zhongshan District, Taipei City</div>
          </div>
          <div class="MapKit">Map kit</div>
          <div class="about">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
          ...
          <div class="Brief">
            Brief description of the event Brief description of the event Brief
            description of the event Brief description of the event Brief
