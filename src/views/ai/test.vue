...
const walletStore = useWalletStore(); // 导入钱包状
...
const shareOnTwitter = async (Role: any, forA: boolean, poolId: number) => {
  window.location.href = `https://twitter.com/i/oauth2/authorize?response_type=code
  &client_id=UXJiQVhpUGxRdkpSeHVXUHVYRmg6MTpjaQ
  &redirect_uri=https://movieai.me/ai/vote
  &scope=tweet.read%20users.read
  &state=yourRandomState
